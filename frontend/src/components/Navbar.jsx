...
const Navbar = ({onLogsClick,onReportsClick}) => {
  ...
  const isActive = true;
  return (
    <motion.nav initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="fixed top-0 left-0 right-0 z-50 glass-panel border-b border-white/20 border-x-0 rounded-none bg-[#0D1013]">
